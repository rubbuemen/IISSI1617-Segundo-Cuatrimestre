...
//Se obtiene los datos de los profesores llamando a la función 'mostrarProfesores'
			...
			<article>
				<div class='contenedor buscadorProfesor'>
					...
					<section class='col-100 tablet-100 movil-100'>
						<h1 class='titulillo alinearCentro'>Buscar profesor</h1>
					</section>
					<section class='col-100 tablet-100 movil-100'>
						<div class='formBuscar'>
							<form class='buscador' id='buscador' name='buscador' method='POST' action='buscarProfesorPerfil.php'>
				...
				<div class='contenedor buscadorProfesor'>
					<section class='col-100 tablet-100 movil-100'>
						<h1 class='titulillo alinearCentro'>Lista de profesores</h1>
					</section>
				</div>
				<br />
					<section class='col-100 tablet-100 movil-100'>
					...
					<?php
						for($pagina = 1; $pagina <= $totalPaginas; $pagina++) 
							...
							<?php 
								...
								<a class='enlacePaginacion' href='buscarProfesorPerfil.php?PAG_NUM=<?php echo $pagina; ?>&PAG_TAM=<?php echo $paginaTamanio; ?>'><?php echo $pagina; ?></a>
							<?php 
							} ?>
							</h1>
							</section>
				<div class='contenedor contenedorForm'>
					...
					foreach($ProfesoresPaginada as $profesor) { ?>
						<form id='formBusqueda' method='POST' action='verProfesor.php' >
