	...
	<body>
		...
		<main>
			<article>
				<div class='contenedor buscadorProfesor'>
					...
					<section class='col-100 tablet-100 movil-100'>
						<div class='formBuscar'>
							<form class='buscador' id='buscador' name='buscador' method='POST' action='buscarAlumnoEditar.php'>
				...
				<div class='contenedor buscadorProfesor'>
					<section class='col-100 tablet-100 movil-100'>
						<h1 class='alinearCentro titulillo'>Lista de alumnos</h1>
					</section>
				</div>
				<br />
					<section class='col-100 tablet-100 movil-100'>
					...
					<?php
						for($pagina = 1; $pagina <= $totalPaginas; $pagina++) 
							...
							<?php 
								...
								<a class='enlacePaginacion' href='buscarAlumnoEditar.php?PAG_NUM=<?php echo $pagina; ?>&PAG_TAM=<?php echo $paginaTamanio; ?>'><?php echo $pagina; ?></a>
							<?php 
							} ?>
							</h1>
							</section>
				<div class='contenedor contenedorForm'>
					...
					foreach($alumnosPaginada as $alumno) { ?>
						<form id='formBusqueda' method='POST' action='editarAlumnoAdmin.php' >
							<input type='hidden' name='DNI' value='<?php echo $alumno['DNI']?>'>
							<input type='submit' name='nombreCompleto' value='<?php echo $alumno['NOMBRE'].' '.$alumno['APELLIDOS']; ?>'>
						</form>
					<?php 
					} ?>
				</div>
